...
void clusterRuns() {
	...
	// 2025
	{392159, 393108}, /*25Cv1*/ {393111, 393609}, /*25Cv2*/
	{394286, 395967}, /*25D*/ {395968, 396597}, /*25E*/
	{396598, 397853}, /*25F*/ {397854, 398860}, /*25G*/
	// 2026
	{401630,401836}, /*26A*/ 
	//{401837,402537} /*26B*/, {402538,402825} /*26C partial*/
	{401837,402535} /*26B*/, {402536,403214} /*26C lowPU*/,
	{403215,403937} /*26D*/	
    };
    ...
    std::vector<std::tuple<int, int, std::string>> era_boundaries2 = {
      ...
      // 2025
      {392159, 393108, "2025Cv1"}, {393111, 393609, "2025Cv2"},
      {394286, 395967, "2025D"}, {395968, 396597, "2025E"},
      {396598, 397853, "2025F"}, {397854, 398860, "2025G"},
      // 2026
      {401630,401836, "2026A"}, //{401837,402537,"2026B"}, {402538,402825,"2026C"} // last one partial
      {401837,402535,"2026B"}, {402536,403214,"2026C"}, {403215,403927,"2026D"}
    };
