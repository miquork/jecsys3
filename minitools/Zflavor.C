...
double fixGluonAdhocSF = 0.97;//0.95;  // default:0 (none), 0.95 for Run2Test 1.3
...
double gluonScale = 1.00;//0.95;//0.990;//0.995;//0.970; // default:1
...
//void Zflavor(double EtaMax = 1.3, string iov = "2025CDEFG") {
//void Zflavor(double EtaMax = 2.5, string iov = "Run2Test") {
  //void Zflavor(double EtaMax = 1.3, string iov="Run2Test") {
//void Zflavor(double EtaMax = 1.3, string iov = "2025FLAVOR") {
void Zflavor(double EtaMax = 1.3, string iov = "2026FLAVOR") {

  gROOT->ProcessLine(".! mkdir pdf/Zflavor");
  gROOT->ProcessLine(".! touch pdf/Zflavor");
  ...
  */
  ...
  //lumi_13TeV = "[Z+jet] Run 3 2025CDEFG, 98.1 fb^{-1}";
  lumi_136TeV = Form("[Z+jet] %s, %s",ci,mlum[ci].c_str());
  ...
  */
  ...
  TFile *ferc = new TFile("pdf/Zflavor/ZflavorRun3Test.root","RECREATE");
