########################################
# CMS Style adapted for the JERC group #
# https://ghm.web.cern.ch/ghm/plots/   #
# Merged all macros into one           #
# Authors: CMS,                        #
#     Mikko Voutilainen, Andrea Malara #
########################################
...
def tdrCanvas(canvName, x_min, x_max, y_min, y_max, nameXaxis, nameYaxis, square=kRectangular, iPos=11, is2D=False, isExtraSpace=False):
  ...
  T = 0.07*H_ref
  B = 0.11*H_ref
  L = 0.13*H_ref #different between cpp and python
  R = 0.03*H_ref #different between cpp and python
