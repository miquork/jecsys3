...
_gf_color["mpfchs1_wqq_a100"]     = kGreen+2;
...
_gf_marker["hdm_mpfchs1_jetz"]     = kFullTriangleUp;//kFullCircle;//kFullStar;
_gf_marker["hdm_mpfchs1_jetz2"]    = kOpenSquare; // For PF
_gf_marker["hdm_mpfchs1_zjav"]     = kFullTriangleDown;//kFullCircle;//kFullStar;
...
_gf_marker["mpfchs1_wqq_a100"]     = kFullStar;
